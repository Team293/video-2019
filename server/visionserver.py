...
#Defines the base class for the VisionServer from which each year's subclass vision server inherits
# From FRC Team 2877
...
class VisionServer:
    ...
    # Logitech c930 are wide-screen cameras, so 424x240 has the biggest FOV
