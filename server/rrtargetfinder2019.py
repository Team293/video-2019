...
#Find the portal retroreflective target for Deep Space 2019
# From FRC Team 2877
...
class RRTargetFinder2019(object):
    # real world dimensions of the various portal targets
    # These are the dimensions of one strip of retroreflective tape
    ...
    CAMERA_TILT = 0.0               # math.radians(-7.5)
    ...
    def __init__(self, calib_file):
        ...
        self.exposure = 1   # Exp=2 @ home, Exp=1 @ shop
